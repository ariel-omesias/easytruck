...
class TrucksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create truck" do
    assert_difference('Truck.count') do
      post trucks_url, params: { truck: { available: @truck.available, description: @truck.description, image: @truck.image, phone: @truck.phone, rate: @truck.rate, stock: @truck.stock, tonnage: @truck.tonnage } }
    end
  ...
  test "should update truck" do
    patch truck_url(@truck), params: { truck: { available: @truck.available, description: @truck.description, image: @truck.image, phone: @truck.phone, rate: @truck.rate, stock: @truck.stock, tonnage: @truck.tonnage } }
